...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title><?php echo $__env->yieldContent('title', 'الموقع الرسمي - حلول مبتكرة وخدمات عالية الجودة'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('description', 'نقدم حلولاً مبتكرة وخدمات عالية الجودة تساعدك على تحقيق أهدافك ونمو أعمالك. تواصل معنا اليوم.'); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('keywords', 'خدمات, حلول, أعمال, استشارات, تطوير'); ?>">
    <meta name="author" content="<?php echo $__env->yieldContent('author', 'Your Company Name'); ?>">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="<?php echo e(url('/')); ?>">
    
    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="<?php echo $__env->yieldContent('og_title', 'الموقع الرسمي - حلول مبتكرة وخدمات عالية الجودة'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('og_description', 'نقدم حلولاً مبتكرة وخدمات عالية الجودة تساعدك على تحقيق أهدافك ونمو أعمالك. تواصل معنا اليوم.'); ?>">
    <meta property="og:image" content="<?php echo e(asset('images/og-image.jpg')); ?>">
    <meta property="og:url" content="<?php echo e(url('/')); ?>">
    <meta property="og:type" content="website">
    <meta property="og:locale" content="ar_SA">
    <meta property="og:site_name" content="<?php echo $__env->yieldContent('site_name', 'Your Company Name'); ?>">
    
    <!-- Twitter Card Meta Tags -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?php echo $__env->yieldContent('twitter_title', 'الموقع الرسمي - حلول مبتكرة وخدمات عالية الجودة'); ?>">
    <meta name="twitter:description" content="<?php echo $__env->yieldContent('twitter_description', 'نقدم حلولاً مبتكرة وخدمات عالية الجودة تساعدك على تحقيق أهدافك ونمو أعمالك.'); ?>">
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <div class="flex items-center">
                    <a href="/" class="text-2xl font-bold text-blue-600 hover:text-blue-700 transition-colors">
                        ...
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" class="h-10 md:h-12" onerror="this.style.display='none'; this.nextElementSibling.style.display='inline';">
...
</html><?php /**PATH C:\Users\HP\Desktop\landing_page\resources\views/layouts/app.blade.php ENDPATH**/ ?>