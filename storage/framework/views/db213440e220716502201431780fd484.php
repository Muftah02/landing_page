        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 animate-fade-in-up"
                     style="animation-delay: <?php echo e($index * 100); ?>ms; animation-fill-mode: both;">
...
<?php /**PATH C:\Users\HP\Desktop\landing_page\resources\views/components/features.blade.php ENDPATH**/ ?>